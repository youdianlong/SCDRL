...
def get_clustered_data(
    ...
    data_list = [preprocess(data, node_feature_dim=node_feature_dim) for data in iterate_datasets(dataset, cache_dir=cache_dir)]
    ...
    if cross_link > 0:
        ...
        data.batch = torch.cat([data.batch, torch.tensor(new_index_list)], dim=0)
    ...
    return data_list, gco_model, raw_data
